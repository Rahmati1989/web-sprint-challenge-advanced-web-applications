...
Answer: 
Token allow user authorization to view protected data. 

2. What steps can you take in your web apps to keep your data secure?
Answer: 
To use private routes and make sure all sensitive data is protected against unauthorized access.

3. Describe how web servers work.
Answer: 
Web server are computer that store a website's component files and uses HTTP to allow the clienet to access the data.

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
Answer:
a) Post Read b) Get Update 3) Put Delete 
